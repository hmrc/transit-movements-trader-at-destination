...
//          )
//
//        println(s"GOODS-RELEASE-MESSAGE $goodsReleasedMessage")
...
//          repository.insert(arrival).futureValue
//
//          println(s"ARRIVAL ORIGINAL: $arrival")
//          println(s"ARRIVAL New Message: $goodsReleasedMessage")
...
//          val updatedArrival = result.value
//
//          println(s"Updated Arrival: $updatedArrival")
...
//          println(s"ARRIVAL_ID: ${arrival.arrivalId}")
//
//          whenReady(result) {
//            r =>
...
//
//          println(s"ARRIVAL: $arrival")
//          println(s"SEARCH: ${arrival.arrivalId}, ${arrival.channel}, ${List(mType)}")
